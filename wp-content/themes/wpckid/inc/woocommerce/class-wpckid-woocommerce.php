	...
	class WPCkid_WooCommerce {
		...
		public function woocommerce_scripts() {
			...
			if ( ! class_exists( 'WPCleverWoofc' ) ) {
				wp_register_script( 'wpckid-header-cart', get_template_directory_uri() . '/assets/js/woocommerce/header-cart' . $suffix . '.js', array(), $wpckid_version, true );
				wp_enqueue_script( 'wpckid-header-cart' );
			}
